...
using AuthRegisterAndLogin.Areas.Identity.Data;
...
namespace AuthRegisterAndLogin.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Mail adresini doğrula",
